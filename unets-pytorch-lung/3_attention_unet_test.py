...
MODEL_PATH = "runs/Attention_Unet/attention_unet_model.pth"
LABELS_SAVE_PATH = "../results/attention_Results"
RESULTS_SAVE_PATH = "test_results/attention_unet"
...
def val_main(test_dir=osp.join(DATASET_PATH, "Test_Images"), result_dir=LABELS_SAVE_PATH,
    ...
    unet = AttentionUnet_Inference(model_path=model_path)
