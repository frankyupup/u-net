...
MODEL_PATH = "runs/UnetPlusPlus/unetpp_model.pth"
LABELS_SAVE_PATH = "../results/unetpp_Results"
RESULTS_SAVE_PATH = "test_results/unetPlusPlus"
...
def val_main(test_dir=osp.join(DATASET_PATH, "Test_Images"), result_dir=LABELS_SAVE_PATH,
    ...
    unet = UnetPPX(model_path=model_path)
